          ...
          <Table>
            <thead>
              <tr className="h-[34px] bg-[#E9EDF1]">
                ...
                <TableHeaderCell isSortable icon={icons.Calendar}>
                  <span>Joined</span>
                </TableHeaderCell>
...
const TableHeaderCell = (props: TableHeaderCellProps) => {
  return (
    <th className="px-[16px] text-[13px] font-normal text-left border border-t-0 first:border-l-0 last:border-r-0 border-[#DFE1E5]">
